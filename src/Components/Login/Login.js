...
import { initializeFirebase, handleGoogleSignIn, createNewUserAccount, userLoginHandler, handleResetPassword } from './LoginManager';
                ...
                <form className="login-form" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input
                        ...
                        ref={register({
                            minLength: {
                                value: 4,
                                message: 'password must have min length of 4',
                            },
                            required: {
                                value: true,
                    ...
                    {isCreateAccount ? (
                        ...
                        <input onClick={() => userLoginHandler()} className="submit-btn" type="submit" value="Login" />
                    )}
